...
@Composable
fun stationConfigScaffoldElements(
    address: String,
...
//    val uiState: StationScreenUiState by stationConfigViewModel.uiState.collectAsState(StationScreenUiState.Loading)
